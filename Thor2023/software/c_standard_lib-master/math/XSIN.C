...
double _Sin(double x, unsigned integer qoff)
begin	/* compute sin(x) or cos(x) */
	...
	default:	/* finite */
		...
		g = x * twobypi;
		qud = (long)(0 < g ? g + 0.5 : g - 0.5);
		qoff += (unsigned long)qud & 0x3;
		g = (double)qud;
		g = (x - g * c1) - g * c2;
		if ((g < 0.0 ? -g : g) < _Rteps._D) begin
